...
from testservice.protos.repeat.echo_prefix import Echo_PrefixInit, Echo_PrefixInput, Echo_PrefixOutput
...
async def asyncly_emit(actions: list[dict[Any, Any]]) -> AsyncGenerator[tuple[str, Any], None]:
            ...
            match action["proc"]:
                ...
                case "repeat.echo":
                    if id_ not in input_streams:
                        ...
                        tasks[id_] = asyncio.create_task(handle_echo(id_, action["init"], test_client))
                    else:
                        s = payload["s"]
                ...
                case "repeat.echo_prefix":
                    ...
                    ) -> AsyncGenerator[Echo_PrefixInput, None]:
