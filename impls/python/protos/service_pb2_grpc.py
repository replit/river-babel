...
class kv(object):
    ...
    def set(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/replit.river.test.kv/set',
    ...
    def watch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/replit.river.test.kv/watch',
            service__pb2.KVRequest.SerializeToString,
            service__pb2.KVResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class repeat(object):
    ...
    def echo(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/replit.river.test.repeat/echo',
...
class uploadStub(object):
    ...
    def __init__(self, channel):
        ...
        self.send = channel.stream_unary(
                ...
                request_serializer=service__pb2.UploadInput.SerializeToString,
                response_deserializer=service__pb2.UploadOutput.FromString,
                )
...
def add_uploadServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'send': grpc.stream_unary_rpc_method_handler(
                    servicer.send,
                    request_deserializer=service__pb2.UploadInput.FromString,
                    response_serializer=service__pb2.UploadOutput.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class upload(object):
    ...
    def send(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/replit.river.test.upload/send',
            service__pb2.UploadInput.SerializeToString,
            service__pb2.UploadOutput.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
